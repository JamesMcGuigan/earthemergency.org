      ...
      <tr>
        <td >
          ...
          <div align="center">
            ...
            -
            <a href="http://planetarycitizen.open.ac.uk/index.pl?section=EarthEmergency&filter=Filter" target="_blank">Forum</a>
            -
    ...
    <table align="center" cellpadding="0" border="0" width="98%">
      <tr>
        ...
        <td width="140" valign="top">
          ...
          <br>
          <br>
          <a href="http://planetarycitizen.open.ac.uk/index.pl?section=EarthEmergency&filter=Filter" target="_blank"><strong>Forum</strong></a>
          <br>
