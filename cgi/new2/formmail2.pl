...
@recipients = ('^james@starsfaq\.com','^earthemergency@freeuk.com','^james\.mcg@ntlworld\.com');
...
#  open(TXT,"autoreply.txt") || die "Can't open 'autoreply.txt'\n";
#  my @message = <TXT>;
#  close(TXT) || die "Can't close 'autoreply.txt'\n"
#
#
  # Open The Mail Program
#  open(MAILX,"|$mailprog");
#
#  print MAILX "To: $Config{'Email'}\n";
#  print MAILX "From: info@earthemergency.org\n";
#
#  print MAILX "To: James@starsfaq.com\n";
#  print MAILX "To: $Config{'Email'}\n";
#  print MAILX "From:  Earthemergency <info@earthemergency.org>\n";
# print MAILX "Subject: Online Form Signature of Earth Emergency - A Call to Action Declaration\n";
#  print MAILX "\n";
#  print MAILX "@message\n";
#  close (MAILX); 
#}
...
sub send_autoreply {
    ...
    if ($Config{'subject'}) { print MAIL "Subject: Online Form Signature of Earth Emergency - A Call to Action Declaration\n"\n\n" }
    else                    { print MAIL "Subject: Online Form Signature of Earth Emergency - A Call to Action Declaration\n"\n\n" }
...
<!-- Inserting Title Here will overwride the language select version
...
<body text="#003300" link="#006600" alink="#000000" vlink="#006600">
...
<table border="0" align="center" cellpadding="0" width="98%">
  ...
  <tr>
    <td >
	    ...
	    <div align="center" class="heading-main">Earth Emergency</div>       
...
<table align="center" cellpadding="0" border="0" width="98%">
  <tr>
	  ...
	  <td width="140" valign="top">
			<a href="../call.htm">A Call To Action</a> <br>
      A declaration of change for the future.<br>
      <br>
      <a href="../wfc.htm">World Future Council</a><br>
      A body to represent civic society and our shared human values and traditions.<br>
      <br>
      <a href="../sign.htm">Sign Declaration</a><br>
      <br>
      <a href="../signatories.htm">View Signatories</a>
<br>
            <br>
      <a href="../resources.htm">Resources</a> <br>
      Links to various resources<br>
      
            <br>
      <a href="http://earthsummit.open.ac.uk/article.pl?sid=02/08/08/0851229"><strong>Forum</strong></a><br>
      A
place to discuss the declaration and its implications<br>
      <br>
      <a href="http://www.sustainable-society.co.uk/"><strong>Directory</strong></a><br>
Links to orginizations working towards a sustainable society<br>
      <br>
      </td>
    <!-- Center Panel -->
	  <td valign="top">
...
<div align="center" class="heading-plus1">Sorry, there was an error submitting the online form.
<br>
...
<!-- InstanceEndEditable -->		
    ...
    <!-- Right Panel -->
	  <td width="140" valign="top">
            ...
            <a href="http://www.earthcharter.org/" target="_blank">
            <strong>The Earth Charter</strong></a><br>
      The Charter is an authoritative synthesis of values, principles, and aspirations reflecting extensive international consultations.<br>
      <br>
            <a href="http://www.earthcharter.org/" target="_blank"><strong>Living Planet Report</strong></a><br>
      WWF's periodic update on the state of the world's ecosystems - as measured by the Living Planet Indexand Ecological Footprint. <br>
      <br>
      <a href="http://www.unep.org/geo/geo3" target="_blank"><strong>GEO3</strong></a><br>
      UNEP Global Environmental Outlook - charts the environmental degradation of the last 30 years since the first world environment conference in Stockholm in 1972.<br>
      <br>
      <a href="http://www.joburgmemo.org" target="_blank">The Jo'burg Memo</a><br>
							An agenda for equity 
              and ecology for the next decade. Environmental care is key for ensuring livelihood and health 
              for the marginalised  and that there 
              can be no poverty eradication without ecology. </td>
  </tr>
