...
#      - Added printing of Name & email in HTML output (orig Ashley Bass)#
...
#          courtesy_reply_text_file, Use file for body of email               #
#                                     it overides all other tags used in body #
...
sub return_html {
    ...
    # Otherwise, begin printing the response page.                           #
        ...
        #    Also Name and email fields (orig Ashley Bass)
        print "<table cellspacing=2 cellpadding=1>";
        if ($Config{'Name'}) {
          print "<tr><td align=right><b>Name:</b></td>";
          print "<td align=left>$Config{'Name'}</td></tr>\n"
        }
...
#BSS
  ...
  if ($Config{'cc_visitor'})
          { print MAIL "Cc: $Config{'Email'} ($Config{'Name'})\n"};
...
#BSS
    ...
    print MAIL "    It was submitted by: $Config{'Name'} ($Config{'Email'})\n    on $date\n";
...
##############################################################################
# Insert Missing Fields HTML code                                            #
##############################################################################
print <<"(END ERROR HTML)";
Content-type: text/html
...
<br>
      ...
      <a href="initiatives.htm">Initiatives</a> 
      <br>
      Coalitions, initiatives and campaigns for action<br>
      <br>
      <a href="http://www.sustainable-society.co.uk/"><strong>Directory</strong></a><br>
The sustainable society directory [on our sister site]  links to orginizations working towards a sustainable society<br>
      <br>
      <a href="http://earthsummit.open.ac.uk/article.pl?sid=02/08/08/0851229" target="_blank"><strong>Forum</strong></a><br>
      An open forum to discuss the declaration and its implications      on the Earth Summit for All website.<br>
      <br>
...
(END ERROR HTML)
##############################################################################
# End of Missing Fields HTML code                                            #
##############################################################################
